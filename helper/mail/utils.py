...
print(date_for_otchet)
    ...
    sql = f"""
        ...
        WHERE  
         ...
         AND t.create_time <= '2024-02-05 18:00:00' 
    ...
    fields = [
              '№п/п','Дата поступления', 'Время поступления', 'Номер обращения', 'Массовый инцидент', 'Заявитель(фамилия и инициалы)',
              ...
              'create_time', 'exec_time', 'status', 'service', 'queue', 'SLA', 'norm', 'SLA', 'fact', 'время: Зарегистрирована',
